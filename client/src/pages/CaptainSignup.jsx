...
const CaptainSignup = () => {
  ...
  const handleSubmit = async e => {
    e.preventDefault();
    try {
      const response = await axios.post("http://localhost:4000/captain/register", {
        fullname,
        email,
        password,
      });
      ...
      <div className="p-7 flex flex-col justify-between h-screen">
              ...
              <div className="bg-green">
                ...
                <p className="text-[10px] leading-tight text-center px-4 max-w-md mx-auto">
                  This site is protected by reCAPTCHA and the <span className="underline">Google Privacy Policy</span> and <span className="underline">Terms of Service apply</span>Terms of Service apply.
                </p>
              </div>
            </div>
    </div>
